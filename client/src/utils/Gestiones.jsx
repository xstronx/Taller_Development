    ...
    >
      ...
      >
        <motion.button
          ...
          whileHover="hover"
          whileTap="tap"
          className="flex-1 bg-gradient-to-br from-yellow-100 to-yellow-200 hover:from-blue-200 hover:to-white text-white font-semibold py-6 px-6 rounded-xl transition-all border border-gray-700 hover:border-red-500/30 shadow-lg"
        >
          <div className="flex flex-col items-center">
            ...
            <span className="text-red-500 text-lg">Materia Prima</span>
            <span className="text-sm text-black mt-1">Gestión de insumos</span>
          </div>
        </motion.button>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <span className="text-red-500 text-lg">Orden de Trabajo</span>
            <span className="text-sm text-black mt-1">Control de producción</span>
          </div>
        </motion.button>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <span className="text-red-500 text-lg">Reportes</span>
            <span className="text-sm text-black mt-1">Análisis y estadísticas</span>
          </div>
        </motion.button>
      </motion.div>
